...
strSQL = "SELECT * FROM zimbardi.maquinas_maquina A;"
Set listaMaquinas = Server.CreateObject("ADODB.Recordset")
listaMaquinas.Open strSQL, conn
%>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Cadastro de M&aacute;quinas</h1>
						<ol class="breadcrumb">
							<li><i class="fa fa-dashboard"></i> <a href="inicial.asp">Tela Inicial</a></li>
							<li class="active"><i class="fa fa-file"></i> M&aacute;quinas </li>
						</ol>
					</div>
				</div>
				<!-- /.row -->
				<div class="row">
					<div class="col-lg-6">
						<form role="form" class="formcliente" action="salvar_maquina.asp" method="post" name="frm_maquina">
							<input type="hidden" name="id_maquina">
							<div class="form-group">
								<label>Nome da M&aacute;quina</label> <input type="text" class="form-control" name="nome_maquina">
							</div> 
                            <br/>
...
<% 									Do While not listaMaquinas.EOF 
										...
										Response.Write ("<tr>")
										Response.Write ("<td><a href='editar_maquina.asp?id=" & listaMaquinas("id_maquina") & "'>" & listaMaquinas("nome_maquina") & "</a></td>")
										Response.Write ("<td><a href='excluir_maquina.asp?id=" & listaMaquinas("id_maquina") & "' title='Excluir' class='fa fa-times'></a></td>")
										Response.Write ("</tr>")
