...
strSQL = "SELECT * FROM zimbardi.usuarios;"
Set listaUsuarios = Server.CreateObject("ADODB.Recordset")
listaUsuarios.Open strSQL, conn
%>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Lista de Usu&aacute;rios</h1>
						<ol class="breadcrumb">
				...
				<div class="row">
					<div class="col-lg-6">
						<form role="form" class="formcliente" action="salvar_usuario.asp" method="post" name="frm_usuario">
							<input type="hidden" name="id_usuario">
							<div class="form-group">
								<label>Nome de Usu&aacute;rio</label> <input type="text" class="form-control" name="nome_usuario">
							</div> 
							<div class="form-group">
							...
							<div class="form-group">
								<label>Senha</label> <input type="password" class="form-control" name="senha">
							</div>
                            <br/>
						...
						<div class="table-responsive">
							<table class="table table-bordered table-hover tabelacliente">
								...
								<tbody>
<% 									Do While not listaUsuarios.EOF 
										'Write the HTML to display the current record in the recordset 
										Response.Write ("<tr>")
										Response.Write ("<td><a href='editar_usuario.asp?id=" & listaUsuarios("id_usuario") & "'>" & listaUsuarios("nome_usuario") &"</a></td>") 
										Response.Write ("<td><a href='editar_usuario.asp?id=" & listaUsuarios("id_usuario") & "'>" & listaUsuarios("login") & "</a></td>")
										Response.Write ("<td><a href='editar_usuario.asp?id=" & listaUsuarios("id_usuario") & "'>" & listaUsuarios("login") & "</a></td>")
										Response.Write ("<td><a href='excluir_usuario.asp?id=" & listaUsuarios("id_usuario") & "' title='Excluir' class='fa fa-times'></a></td>")
										Response.Write ("</tr>")
